...
function configureLinuxRuntime() {
  ...
  // AppImage and unpacked Linux builds commonly lack a root-owned setuid
  // chrome-sandbox helper. Prefer predictable startup over hard failure.
  app.commandLine.appendSwitch('no-sandbox');

  // WebGPU/GL init is noisy and flaky on some Linux/NVIDIA setups; the app is
  // still usable with software rendering for its desktop shell.
